...
\documentclass[fontsize=11pt,openright,paper=a4,pointlessnumbers]{scrbook}
...
%\input{BackgroundFit}
\chapter{Search for a kinematic edge}
\input{fit}
\chapter{Interpretation of the search results}
\input{newInterpretation}
\chapter{Conclusion}
\input{conclusion}
\appendix
\input{appendixTrigger}
\input{appendixSamples}
\input{appendixRmue}
\input{appendixRT}
\input{appendixROutIn}
